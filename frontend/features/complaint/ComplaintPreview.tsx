...
const ComplaintPreview: React.FC<ComplaintPreviewProps> = ({ draft }) => {
  return (
    <Card className="p-6 space-y-6 bg-white border shadow-sm">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center pt-6 border-t mt-6">
        <Button 
          className="w-full md:w-auto bg-blue-700 hover:bg-blue-800 text-white px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-md active:scale-95"
        ...
        <Button 
          className="w-full md:w-auto bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-md active:scale-95"
          onClick={() => {
